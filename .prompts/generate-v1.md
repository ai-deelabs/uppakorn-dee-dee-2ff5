...
Full-bleed horizontal scroll with sticky left-rail navigation and dense product-grid columns — Condensed industrial grotesque (headlines) paired with tabular monospace (specs/prices) — Bold duotone: slag orange #E84C0E + graphite #1C1C1C on off-white #F2EDE8, inspired by 1970s Braun industrial catalogs — Precise, no-nonsense, tool-room authority
