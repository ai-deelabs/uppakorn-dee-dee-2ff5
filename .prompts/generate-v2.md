...
Dark-mode hero with diagonal section breaks and oversized numbered callouts anchoring a single-column editorial flow — Compressed slab serif for headlines, light humanist sans for body — Dark canvas: transformer black #0A0A0F + electric cyan #00E5CC + zinc #3A3A4A, referencing Tron Legacy's grid aesthetic — High-voltage, technical precision, night-shift factory floor
